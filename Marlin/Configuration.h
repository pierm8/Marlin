...
#define STRING_CONFIG_H_AUTHOR "(pierm, Artillery Genius)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 17.3703
    #define DEFAULT_Ki  1.3680
    #define DEFAULT_Kd 55.1398
  #endif
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 29, -36, -1 }
